...
(function(){
	...
	*/
	...
	var textTagHtml = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
	console.log(textTagHtml.match(/[<]\w+[>]/g));
	...
	*/
	...
	var textHtmlVazia = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
	console.log(textHtmlVazia.match( /<\w+><\/\w+>/g ));
	...
	*/
	...
	var textInsideTag = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
	console.log(textInsideTag.replace( /<(\w+)>([^<]+)<\/\w+>/g , 
