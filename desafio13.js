...
(function(){
	...
	*/
	var sul = ['Porto Alegre', 'Rio Grande do Sul'];
	var sudeste = ['Minas', 'Sp', 'RJ'];
	...
	*/
	...
	// var norte = ['Amazonas','Para','Roraima'];
	brasil.unshift('Amazonas', 'Para','Roraima');
	console.log(brasil);
	/*
