...
(function(){
	...
	*/
	...
	esta tenha muitas linhas, deve sempre casar com númeroeros no início de cada
	...
	*/
	...
	function hasClass ( markup, cssClass ){
		var regexTest = new RegExp( 'class=["\'](?:[\\w\\s]+)?'+cssClass+'(?:[\\w\\s]+)?["\']', 'gm');
		// console.log(regexTest);
		return markup.match(regexTest) ? true : false;
	}

	var classTest = [ 'container', 'text' , 'date' , 'excerpt' , 'main' ];
	classTest.forEach(function(cssClass){
