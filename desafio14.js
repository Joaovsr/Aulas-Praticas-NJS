...
(function(){
	...
	*/
	...
	// }
	// console.log('Array com apenas números do array acima:');
	...
	*/
	...
	reduceP = name.reduce(function(acumulado,item){
		return 'p'+acumulado + item;
	},'')
	console.log(reduceP);
	...
	*/
	...
	// não pois eles ocupam lugar na memoria diferente, então apesar da string ser igual o objeto não é.
